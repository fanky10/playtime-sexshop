		...
		<div class="wrapper">
			...
			<div class="contenedor">
				...
				<div class="lateral" id="lateral_izquierdo">
        	        ...
        	        <?php
                        include_once ROOT_DIR .'/menu_categorias.php';
                    ?>
				...
				<div class="contenido">
					...
					<div id="contenido_central">
                                            ...
                                            <h1 class="categoria"><span>Zonas</span></h1>
                                        
                                            <a href="zone_am.php" class="formButton">Nueva Zona</a>

                                            <br/>
                                            <br/>
                                            <?php                            
                                                include_once 'zone_list.php';
                                            ?>
